...
export function seed() {
  ...
  const dashboards = [
    { name: 'Helpdesk Overview', folder: 'f-svc', category: 'Service Desk', owner: 'Aarav Mehta', access: 'public', predefined: true, favorite: true, certified: true, description: 'Live service-desk health: open volume, SLA, backlog and P1 worklist.', tiles: helpdeskTiles(), updated: days(0) },
